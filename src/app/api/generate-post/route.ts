...
export async function POST(req: Request) {
  ...
  const prompt =
    "Generate a markdown blog post about the Elixir programming language. Also include code snippets of example code";
  ...
  const res = await adminDb.collection("postsContent").add(postContent);
